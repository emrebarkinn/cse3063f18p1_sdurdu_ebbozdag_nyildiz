...
public class Board {
    ...
    public Board() {
        ...
        //blocks.add(new Block(4, "Gelir vergisi öde")); //??
        blocks.add(new LuckyCard(5, "Lucky Card"));
        //blocks.add(new Block(5, "Tren"));               //olusturulmadı
        ...
        //blocks.add(new Block(20, "Free Parking"));
        ...
        //blocks.add(new Block(25, "Tren"));              //olusturulmadı
